...
import com.acme.greeter.systemtest.entity.GreetingEntity;
...
/**
 * Test Greeter Resource inside the container using a delegating "fake" instance
 * of Greeter Service. This ability comes in handy when testing service
 * endpoints that may cost you money (i.e. Credit Card processing service).
 *
 * @author saden
 */
